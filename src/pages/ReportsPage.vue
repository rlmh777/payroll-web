...
import { ref } from 'vue';
import JournalEntriesReport from 'src/components/reports/JournalEntriesReport.vue';
import PayrollJournalDepartmentsReport from 'src/components/reports/PayrollJournalDepartmentsReport.vue';
import PayrollSummaryByDepartmentReport from 'src/components/reports/PayrollSummaryByDepartmentReport.vue';
import SalaryReviewReport from 'src/components/reports/SalaryReviewReport.vue';
