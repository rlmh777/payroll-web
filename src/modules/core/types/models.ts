...
export interface EmployeeLeaveAttachment {
  id: string;
...
export interface EmployeeIncidentAttachment {
  id: string;
  employeeIncidentId: string;
  filePath: string;
  fileName: string;
  mimeType?: string | null;
  fileSize?: number | null;
...
export interface EmployeeIncident {
  ...
  reported_by?: Pick<Employee, 'id' | 'code' | 'firstName' | 'lastName'> | null;
  reportedBy?: Pick<Employee, 'id' | 'code' | 'firstName' | 'lastName'> | null;
  department?: { id: number; name: string } | null;
  worksite?: { id: number; name: string } | null;
  attachments?: EmployeeIncidentAttachment[];
}

export interface EmployeeIncidentPayload {
  employeeId: string;
  incidentDate: string;
  reportedDate?: string | null;
  incidentType: string;
