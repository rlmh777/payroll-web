    ...
    >
      <template #option="scope">
        ...
        <q-item v-else v-bind="scope.itemProps">
          ...
          <q-item-section v-if="crudFlags.showEdit && !readonly && !disable" side>
            <q-btn
              flat
              round
              dense
...
const { withCrudFlags } = useCrudPermission('department');
...
const departmentOptions = computed(() => {
  ...
  if (crudFlags.showAddNew.value && !props.readonly && !props.disable) {
