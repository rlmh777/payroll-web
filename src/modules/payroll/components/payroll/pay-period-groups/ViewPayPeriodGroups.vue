<template>
  <div class="row q-gutter-md items-start">
    ...
    <!-- Add / Edit Pay Period Schedule Dialogs -->
    <AddPayPeriodSchedule
      v-model="showAddScheduleDialog"
      :pay-period-group-id="selectedGroup?.id ?? null"
    />
    <EditPayPeriodSchedule
...
import AddPayPeriodSchedule from '../pay-period-schedules/AddPayPeriodSchedule.vue';
import EditPayPeriodSchedule from '../pay-period-schedules/EditPayPeriodSchedule.vue';
...
const selectedSchedule = ref<PayPeriodSchedule | null>(null);
...
const openEditScheduleDialog = (schedule: PayPeriodSchedule) => {
