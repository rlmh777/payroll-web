...
import { useCalendarStore, type CalendarEmployee } from 'src/stores/calendar-store';
import {
  getActiveEmploymentDetail,
  getEmploymentContractOptions,
} from 'src/utils/calendar-employment-utils';
import { formatCalendarDisplayDate, normalizeDateRange } from 'src/utils/calendar-event-utils';
