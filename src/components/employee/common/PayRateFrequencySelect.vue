...
import AddPayrateFrequency from '../../payrate-frequency/AddPayrateFrequency.vue';
import EditPayrateFrequency from '../../payrate-frequency/EditPayrateFrequency.vue';
...
const filterFrequencies = (val: string, update: (callback: () => void) => void) => {
  ...
  if (searchTerm) {
    filterTimeout.value = setTimeout(() => {
      void payrateFrequencyStore.fetchPayrateFrequencies(1, 100, searchTerm);
    }, 300);
  }
};
